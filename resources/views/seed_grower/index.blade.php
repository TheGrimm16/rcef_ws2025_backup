    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel shadow-2xl" style="padding-bottom: 3em;">
                <div class="x_title">
                    <h1>Add Seed Grower</h1>
                    <div class="clearfix"></div>
                </div>

                <div id="seedGrowerForm">
                    <form class="form">
                        <div class="dropDown">
                            <select name="coop" id="coop">
                                <option value="default">Select Cooperative</option>
                                @foreach($getCoops as $coop)
        ...
        $("#submit").click(function (event) {
            ...
            if(coop == "default")
            {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Please select a cooperative!',
                })
            }

            if(firstName.length > 0 && lastName.length > 0 && coop != 'default')
            {
                event.preventDefault();
                $.ajax({ 
                type: 'POST',
                url: "{{ route('saveSeedGrower') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    firstName: firstName,
                    ...
                    if (data == 0)
                {
                    Swal.fire({
                        icon:'success',
                        title: 'Success!',
                        text: 'Seed Grower has been added successfully!',
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Seed Grover already exists!',
                    })
                }
