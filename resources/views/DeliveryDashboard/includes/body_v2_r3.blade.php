            ...
            <div style="position:absolute; top:80px;width: 65%">
                <div style="width:90%;margin: 0 auto;">
                    ...
                    <div class="">
                        ...
                        @php 
                            $signatories = array(
                                "NUEVA ECIJA" => "Engr. Lorenzo Lopez Jr.",
                                "PAMPANGA" => "Engr. Lorenzo Lopez Jr.",
                                "TARLAC" => "Engr. Lorenzo Lopez Jr.",
                                "AURORA" => "Jhoemar Dela Cruz",
                                "BATAAN" => "Jhoemar Dela Cruz",
                                "BULACAN" => "Jhoemar Dela Cruz",
                                "ZAMBALES" => "Jhoemar Dela Cruz"
                            );
                            ...
                            $position = array(
                                ...
                                "PAMPANGA" => "CES PDO",
                                "TARLAC" => "CES PDO",
                                "AURORA" => "CES Regional Coordinator",
                                "BATAAN" => "CES Regional Coordinator",
                                "BULACAN" => "CES Regional Coordinator",
                                "ZAMBALES" => "CES Regional Coordinator"
                            );
                        @endphp

                       {{$signatories[$province]}}
                       {{-- Jhoemar B. Dela Cruz --}}
                    </div>
                </div>
            </div>
             <div style="position:absolute; top:120px;width: 65%">
                <div style="width:90%;margin: 0 auto;">
                    ...
                    <div class="">
                       {{-- CES Regional Coordinator / FOMD, RCEF-PMO --}}
                       {{$position[$province]}}
                    </div>
                </div>
            </div>
...
<table>
    ...
    <table> 
        <tr> <td> <font style=" position: fixed; bottom: 0; text-align:left; font-size: 12px; font-style:italic; color: #808080;" >PhilRice RCEF Seed IAR Rev 01 Effectivity Date: 29  June 2021</font> 
            </td>
