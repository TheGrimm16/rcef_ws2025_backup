    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel shadow-2xl" style="padding-bottom: 3em;">
                <div class="x_title">
                    <h1>Binhi e-Padala to Regular Update</h1>
...
@push('scripts')
    ...
    <script>
        ...
        $("#submit").click(function (event) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to transfer this farmer's profile to conventional?",
                icon: 'warning',
                        ...
                        success: function(data){
                            if (data == 0)
                            {
                                Swal.fire({
                                    icon:'success',
                                    title: 'Success!',
                                    text: 'Successfully transferred farmer from BeP to Conventional!',
