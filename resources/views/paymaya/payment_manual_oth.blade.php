  ...
  <div>
    ...
    <table style="border:none; font-size: 12pt" width="95%"> 
      ...
      <tr style =" border:none; vertical-align:top">
        ...
        <td  style ="border:none; text-align:left; border-bottom:1px solid black;" ><b><strong>{{$total_arrs["net_words"]}}</strong></b></td>
      </tr>

      <tr style =" border:none; vertical-align:top">
        <td  style ="border:none; text-align:left;" ></td>
        <td  style ="border:none; text-align:left; border-bottom:1px solid black;" >PHP {{$total_arrs["net_format"]}}</td>
      </tr>
      ...
      <p>TO:<br>
        ...
        <table style="border:none; font-size: 11pt" width="100%" align="center"> 
          <tr style =" border:none; vertical-align:top">
            ...
            {{$r++}}
              ...
              @foreach($row["details"] as $details)
                  <tr style =" border:none; vertical-align:top">
                    <td colspan="2;" style ="border:none; text-align:center; font-size: 10pt;" >{{$details->coop_name}}</td>
                    <td colspan="2;" style ="border:none; text-align:center;  font-size: 10pt;"  >{{$details->address_1}}</td>
                    <td style ="border:none; text-align:center;" >{{$details->branch}}</td> 
                    <td style ="border:none; text-align:center;" >{{$details->account_no}}</td> 
                    <td style ="border:none; text-align:center;" >{{number_format($net_amount,2)}}</td> 
                  </tr>
          ...
          <tr style =" border:none; vertical-align:top">
            ...
            <th  style ="border:none; text-align:center; border-bottom:1px solid black; font-size: 12pt" >{{$total_arrs["net_format"]}}</th>    
          </tr>
