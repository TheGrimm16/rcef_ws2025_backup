...
public function exportMunicipalStatistics($date_from, $date_to, $region){
    $prv = DB::connection("delivery_inspection_db")->table("lib_dropoff_point")
        ...
        $scriptPath = base_path('app//Http//PyScript//reports//dro_report//exportMunicipalStatistics.py');
 ...
 public function exportMunicipalStatistics_OLD($date_from, $date_to, $region){
