...
class virtual_encodingController extends Controller
{
    ...
    public function index_homeAddressClaim(){
        ...
        if(Auth::user()->roles->first()->name == "rcef-programmer"){
            ...
            $provinceList = ["LEYTE","NEGROS OCCIDENTAL","BULACAN","NUEVA ECIJA","AURORA","BATAAN","PAMPANGA","TARLAC","ZAMBALES","LAGUNA","LA UNION"];
            $user_provinces = DB::table($GLOBALS['season_prefix'].'rcep_delivery_inspection.lib_prv')
            ->select('lib_prv.province')
                ...
                if($key == 0){
                    if($request->served == "false"){
                        ...
                        if($claiming_lib != null){
                            $prv_db = $claiming_lib->prv_code;
                                ...
                                if($rcef_id == ""){
                                    ...
                                    while ($checker_2==0) {
                                        ...
                                        $da_farmer_profile =  DB::table($GLOBALS['season_prefix']."prv_".$prv_db.".farmer_information_final")
                            ...
                            $fins["mother_name"] = $request->mother_last_name;
                                    ...
                                    if($checkParcelDop !=''){
                                        if($prv_code_released!=$home_code_released)
                                        {
                                            ...
                                            ->insert([
                                                ...
                                                "mother_name" => $getParcelProfile->mother_name,
           ...
           $may_data = DB::table($prefix."prv_".$prv_claiming.".".$conn)
            ...
            // })
               ...
               if($may_data != null){
                   ...
                   $mother_name = $may_data->mother_name;
