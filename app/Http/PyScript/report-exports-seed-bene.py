...
def main(ssn, prv, mun, cat, province):
    ...
    report_headers = ['db_ref', 'rcef_id_x', 'rsbsa_control_no', 'firstName', 'midName', 'lastName', 'extName', 'sex_y', 'birthdate_y', 'tel_no', 'province_x', 'municipality_x', 'mother_name', 'final_area_y', 'claimed_area', 'bags_claimed', 'seed_variety', 'remarks', 'is_replacement_x', 'crop_establishment_cs_x', 'seedling_age', 'ecosystem_cs_x', 'planting_week_x', 'kp_kit_count', 'other_benefits_received', 'date_released', 'released_by', 'server_date_received', 'category', 'app_version', 'yield_last_season_details']
    ...
    def extract_yield(df):
        ...
        polar_df = polar_df.rename({"db_ref": "DBREF", "rcef_id_x": "RCEF ID", "rsbsa_control_no": "RSBSA Control No", "firstName": "First Name", "midName": "Middle Name", "lastName": "Last Name", "extName": "Extension Name", "sex_y": "Sex", "birthdate_y": "Birthdate", "tel_no": "Contact Number", "province_x": "Province", "municipality_x": "Municipality", "mother_name": "Mother Name", "final_area_y": "Final Area", "claimed_area": "Claimed Area", "bags_claimed": "Bags Claimed", "seed_variety": "Seed Variety", "remarks": "Remarks", "is_replacement_x": "Replacement", "crop_establishment_cs_x": "Crop Establishment", "seedling_age": "Seedling Age", "ecosystem_cs_x": "Ecosystem", "planting_week_x": "Planting Week", "kp_kit_count": "KP Kit Count", "other_benefits_received": "Other Benefits Received", "date_released": "Date Released", "released_by": "Released By", "server_date_received": "Sync Date", "category": "Category", "app_version": "App Version"})
